    ...
    */
    ...
    'components' => [
        ...
        */
        ...
        // Disabled: 'icon' is our own shared x-icon component
        // (resources/views/components/icon.blade.php, docs/CLAUDE.md
        // Section 8.2) — the package's tag would otherwise override it.
        'default' => null,
